...
antenna_gain = 10 * math.log(radiation_efficiency * ((4 * np.pi * (np.pi * Spacecraft.antenna_d**2 / 4))/Lambda**2), 10) # dB
...
generatd_data_rate = n_pixels_line * lines_per_second * Payload.bit_depth   # bits/s
